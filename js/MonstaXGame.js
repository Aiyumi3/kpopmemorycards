...
function createBoard() {
    ...
    for (let i = 0; i < countCards; i++) {
        ...
        li.id = i;
        //li.style.backgroundImage = 'url("./images/monstax/logo_monstax.jpg")';
    ...
    cardsField.onclick = (e) => {
        if (pause === false) {
            ...
            if (element.tagName == "LI" && element.className !== "active") {
                ...
                element.style.backgroundImage = `url("./images/monstax/${cardArr[element.id]}.jpg")`;
                ...
                if (selectedCards.length === 2) {
                    ...
                    if (cardArr[selectedCards[0].id] === cardArr[selectedCards[1].id]) {
                        ...
                        progressBar.style.width = `${progressNum += 16.6}%`;//n    -------
...
function reset() {
	for(let i = 0; i < countCards; i++) {
		cardsField.children[i].style.backgroundImage = 'url("./images/monstax/logo_monstax.jpg")';
