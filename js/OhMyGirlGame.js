...
function createBoard() {
    ...
    for (let i = 0; i < countCards; i++) {
        ...
        li.id = i;
        //li.style.backgroundImage = 'url("./images/ohmygirl/logo_ohmygirl.jpg")';
    ...
    cardsField.onclick = (e) => {
        if (pause === false) {
            ...
            if (element.tagName == "LI" && element.className !== "active") {
                ...
                element.style.backgroundImage = `url("./images/ohmygirl/${cardArr[element.id]}.jpg")`;
                ...
                if (selectedCards.length === 2) {
                    ...
                    if (cardArr[selectedCards[0].id] === cardArr[selectedCards[1].id]) {
                        ...
                        progressBar.style.width = `${progressNum += 14.3}%`;//n    -------
...
function reset() {
	for(let i = 0; i < countCards; i++) {
		cardsField.children[i].style.backgroundImage = 'url("./images/ohmygirl/logo_ohmygirl.jpg")';
