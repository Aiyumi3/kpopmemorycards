...
function createBoard() {
    ...
    for (let i = 0; i < countCards; i++) {
        ...
        li.id = i;
        //li.style.backgroundImage = 'url("./images/itzy/logo_itzy.jpeg")';
    ...
    cardsField.onclick = (e) => {
        if (pause === false) {
            ...
            if (element.tagName == "LI" && element.className !== "active") {
                ...
                element.style.backgroundImage = `url("./images/itzy/${cardArr[element.id]}.jpeg")`;
...
function reset() {
	for(let i = 0; i < countCards; i++) {
		cardsField.children[i].style.backgroundImage = 'url("./images/itzy/logo_itzy.jpeg")';
